...
public class Fragment_1 extends Fragment {
    ...
    EditText kor1, kor3, kor4, eng1, eng3, eng4, math1,math3,math4,input;
    TextView ackor, aceng, acmath, limsiTV;
    TextView result,result2;
    private static final String ARG_PARAM1 = "3.141592";
    private static final String ARG_PARAM2 = "6.283185";


    // https://3unkong.tistory.com/5
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_fragment_1,null);
        //imm = (InputMethodManager)this.Activity.getSys
        ...
        Button btn_server = (Button) view.findViewById(R.id.button1);
        btn_server.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).onescore=notbutrealresult;
